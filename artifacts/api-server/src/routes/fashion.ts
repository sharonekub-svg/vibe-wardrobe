...
const DIVIDED_ITEMS = [
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1564564321837-a57b7070ac4f?auto=format&fit=crop&w=600&q=80",
    category: "Blouses",
    collection: "divided",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1562572159-4efc207f5aff?auto=format&fit=crop&w=600&q=80",
    category: "Tops",
    collection: "divided",
  ...
  },
  {
    ...
    price: 34.99,
    formattedPrice: "$34.99",
    imageUrl: "https://images.unsplash.com/photo-1596171446957-56a8c1e88327?auto=format&fit=crop&w=600&q=80",
    category: "Skirts",
    collection: "divided",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1551537482-f2075a1d41f2?auto=format&fit=crop&w=600&q=80",
    category: "Jackets",
    collection: "divided",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1582142839970-2b9e04b60f65?auto=format&fit=crop&w=600&q=80",
    category: "Knitwear",
    collection: "divided",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1549062572-544a64fb0c56?auto=format&fit=crop&w=600&q=80",
    category: "Tops",
    collection: "divided",
  ...
  },
  {
    ...
    price: 24.99,
    formattedPrice: "$24.99",
    imageUrl: "https://images.unsplash.com/photo-1591369822096-ffd140ec948f?auto=format&fit=crop&w=600&q=80",
    category: "Shorts",
    collection: "divided",
  ...
  },
  {
    ...
    price: 17.99,
    formattedPrice: "$17.99",
    imageUrl: "https://images.unsplash.com/photo-1618932260643-eee4a2f652a6?auto=format&fit=crop&w=600&q=80",
    category: "Tops",
    collection: "divided",
  ...
  },
  {
    ...
    price: 29.99,
    formattedPrice: "$29.99",
    imageUrl: "https://images.unsplash.com/photo-1566206091558-7f218b696731?auto=format&fit=crop&w=600&q=80",
    category: "Dresses",
    collection: "divided",
...
// Pull & Bear — street/boho women's styles (mixed into both age groups)
const PULLBEAR_ITEMS = [
  {
    id: "pb-3001",
    ...
    category: "Dresses",
    collection: "pullbear",
    tags: ["dress", "boho", "floral", "maxi", "summer", "feminine"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/dresses-n5901",
  },
  {
    id: "pb-3002",
    ...
    category: "Jeans",
    collection: "pullbear",
    tags: ["jeans", "denim", "straight-leg", "bottoms", "casual"],
  ...
  },
  {
    ...
    price: 27.99,
    formattedPrice: "$27.99",
    imageUrl: "https://images.unsplash.com/photo-1502716119720-816e28e10df5?auto=format&fit=crop&w=600&q=80",
    category: "Sweatshirts",
    collection: "pullbear",
    tags: ["sweatshirt", "graphic", "oversized", "casual", "tops"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/sweatshirts-n5908",
  },
  {
    id: "pb-3004",
    name: "Knit Crochet Crop Top",
    price: 22.99,
    formattedPrice: "$22.99",
    imageUrl: "https://images.unsplash.com/photo-1525507119028-ed4c629a60a3?auto=format&fit=crop&w=600&q=80",
    category: "Tops",
    collection: "pullbear",
    tags: ["crop-top", "crochet", "knit", "boho", "tops", "summer"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/tops-n5903",
  },
  {
    id: "pb-3005",
    name: "Longline Trench Coat — Beige",
    price: 69.99,
    formattedPrice: "$69.99",
    imageUrl: "https://images.unsplash.com/photo-1539533018447-63fcce2678e3?auto=format&fit=crop&w=600&q=80",
    category: "Coats",
    collection: "pullbear",
    tags: ["coat", "trench", "beige", "outerwear", "classic"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/coats-n5910",
  },
  {
    id: "pb-3006",
    name: "Satin Mini Slip Dress — Champagne",
    price: 32.99,
    formattedPrice: "$32.99",
    imageUrl: "https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&w=600&q=80",
    category: "Dresses",
    collection: "pullbear",
    tags: ["dress", "satin", "slip", "mini", "champagne", "party"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/dresses-n5901",
  },
  {
    id: "pb-3007",
    name: "Wide-Leg Linen Trousers — White",
    price: 34.99,
    formattedPrice: "$34.99",
    imageUrl: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?auto=format&fit=crop&w=600&q=80",
    category: "Trousers",
    collection: "pullbear",
    tags: ["trousers", "linen", "wide-leg", "white", "summer", "bottoms"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/trousers-n5900",
  },
  {
    id: "pb-3008",
    name: "Cropped Denim Jacket — Washed Blue",
    price: 45.99,
    formattedPrice: "$45.99",
    imageUrl: "https://images.unsplash.com/photo-1571513722275-4b41940f54b8?auto=format&fit=crop&w=600&q=80",
    category: "Jackets",
    collection: "pullbear",
    tags: ["denim", "jacket", "cropped", "outerwear", "casual"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/jackets-n5909",
  },
  {
    id: "pb-3009",
    name: "Floral Midi Wrap Skirt",
    price: 27.99,
    formattedPrice: "$27.99",
    imageUrl: "https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=600&q=80",
    category: "Skirts",
    collection: "pullbear",
    tags: ["skirt", "midi", "wrap", "floral", "boho", "bottoms"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/skirts-n5902",
  },
  {
    id: "pb-3010",
    name: "Ribbed Knit Halter Top — Black",
    price: 19.99,
    formattedPrice: "$19.99",
    imageUrl: "https://images.unsplash.com/photo-1434389677669-e08b4cac3105?auto=format&fit=crop&w=600&q=80",
    category: "Tops",
    collection: "pullbear",
    tags: ["halter", "ribbed", "knit", "black", "tops", "party"],
    buyUrl: "https://www.pullandbear.com/en/woman/clothing/tops-n5903",
  },
];
...
const WOMENS_ITEMS = [
  ...
  },
  {
    ...
    price: 69.99,
    formattedPrice: "$69.99",
    imageUrl: "https://images.unsplash.com/photo-1594938403095-40e5f7bd9aff?auto=format&fit=crop&w=600&q=80",
    category: "Jackets",
    collection: "ladies",
  ...
  },
  {
    ...
    imageUrl: "https://images.unsplash.com/photo-1572804013427-4d7ca7268217?auto=format&fit=crop&w=600&q=80",
    category: "Dresses",
    collection: "ladies",
...
router.get("/fashion/items", async (req, res) => {
  ...
  const pool = ageNum !== null && ageNum < 20
    ? [...DIVIDED_ITEMS, ...PULLBEAR_ITEMS]
    : [...DIVIDED_ITEMS, ...WOMENS_ITEMS, ...PULLBEAR_ITEMS];
